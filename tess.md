...
$\sim 80$ % of the data, or about 5,000 stars. We report the $p$-value (based on the Null
Signal Template (NST) developed in the aforementioned paper) for each planetary candidate.
